...
AGachaDemoCharacter::AGachaDemoCharacter()
{
...
void AGachaDemoCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AGachaDemoCharacter::Move);
...
void AGachaDemoCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
